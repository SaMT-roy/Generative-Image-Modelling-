...
class LanguageModelMLP(nn.Module):
    ...
    def __init__(self, cfg, activate_lora=False):
        ...
        self.lora_gate_proj = LoraLayer(self.embd_dim, self.inter_dim, name='lora_gate_proj', active=activate_lora)
    ...
    def forward(self, x):
        ...
        """
        gate = self.activation_fn(self.gate_proj(x) + self.lora_gate_proj(x))
        x = self.up_proj(x)
...
class LanguageModelBlock(nn.Module):
    def __init__(self, cfg, activate_lora=False):
        super().__init__()
        self.mlp = LanguageModelMLP(cfg, activate_lora=activate_lora)
...
class LanguageModel(nn.Module):
    ...
    def from_pretrained(cls, cfg, activate_lora=False):
        ...
        model_dir = '/Users/saptarshimallikthakur/Pictures/VLM/nanovlm'
